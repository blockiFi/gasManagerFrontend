...
const Location = () => {
  ...
  const showLocationMetrics = can(CAPABILITIES.VIEW_ANALYTICS)
    ...
    <div className="flex w-full flex-col gap-6">
      ...
      {showLocationMetrics ? (
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">{dispensersBlock}</div>
        </div>
      ) : (
        <div className="flex flex-col gap-4">{dispensersBlock}</div>
      )}
